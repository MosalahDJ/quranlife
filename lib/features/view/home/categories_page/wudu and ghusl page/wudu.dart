                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  langctrl.language.value == "ar"
                                      ? wuductrl.wuduTeaching[i].descriptionar!
                                      : langctrl.language.value == "fr"
                                          ? wuductrl
                                              .wuduTeaching[i].descriptionfr!
                                          : wuductrl
                                              .wuduTeaching[i].descriptionen!,
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodySmall
                                      ?.copyWith(
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      langctrl.language.value == "ar"
                                          ? wuductrl.wuduTeaching[i].sourcear!
                                          : langctrl.language.value == "fr"
                                              ? wuductrl
                                                  .wuduTeaching[i].sourcefr!
                                              : wuductrl
                                                  .wuduTeaching[i].sourceen!,
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodySmall
                                          ?.copyWith(
