                              ...
                              children: [
                                ...
                                Text(
                                  langctrl.language.value == "ar"
                                      ? controller.teachingprayer[i].titlear!
                                      : langctrl.language.value == "fr"
                                          ? controller
                                              .teachingprayer[i].titlefr!
                                          : controller
                                              .teachingprayer[i].titleen!,
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    langctrl.language.value == "ar"
                                        ? controller
                                            .teachingprayer[i].descriptionar!
                                        : langctrl.language.value == "fr"
                                            ? controller.teachingprayer[i]
                                                .descriptionfr!
                                            : controller.teachingprayer[i]
                                                .descriptionen!,
                                    style: Theme.of(context)
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        langctrl.language.value == "ar"
                                            ? controller
                                                .teachingprayer[i].sourcear!
                                            : langctrl.language.value == "fr"
                                                ? controller
                                                    .teachingprayer[i].sourcefr!
                                                : controller.teachingprayer[i]
                                                    .sourceen!,
                                        style: Theme.of(context)
                                            .textTheme
