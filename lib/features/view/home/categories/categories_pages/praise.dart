                              ...
                              children: [
                                ...
                                Text(
                                  langctrl.language.value == "ar"
                                      ? controller.praiseController[i].titlear!
                                      : langctrl.language.value == "fr"
                                          ? controller
                                              .praiseController[i].titlefr!
                                          : controller
                                              .praiseController[i].titleen!,
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    langctrl.language.value == "ar"
                                        ? controller
                                            .praiseController[i].descriptionar!
                                        : langctrl.language.value == "fr"
                                            ? controller.praiseController[i]
                                                .descriptionfr!
                                            : controller.praiseController[i]
                                                .descriptionen!,
                                    style: Theme.of(context)
